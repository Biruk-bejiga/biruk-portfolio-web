  ...
  return (
    <section id={id} className="py-24 scroll-mt-24">
      ...
      <div ref={ref} className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
        {STATS.map((s) => (
          <motion.div key={s.label} initial={{ opacity: 0, y: 10 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.4 }} className="p-6 rounded-lg bg-gray-50 dark:bg-gray-800">
